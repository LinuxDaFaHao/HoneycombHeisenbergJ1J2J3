...
q1=quiver(site2x_set(selectA),site2y_set(selectA),-sxsx_correlation(selectA)/5,sysy_correlation(selectA),spin_arrow_scale,'linewidth',3);
hold on;
selectB = sxsx_correlation>0;
q2=quiver(site2x_set(selectB),site2y_set(selectB),-sxsx_correlation(selectB)/5,sysy_correlation(selectB),spin_arrow_scale,'linewidth',3);

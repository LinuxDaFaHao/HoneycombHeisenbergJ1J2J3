...
%0.1235 0.0637 0.1031    0.0952      0.0885      0.0826 
J1zz = 5.31;
J2zz = 0.2;
J3zz = -28;
Dzz = -0.113;
...
Tc = 153.5;
msquare_set= msquare_set(:, T_set<Tc & T_set >100);
T_set= T_set(:, T_set<Tc& T_set >100);
exponent = 0.1338;
for l = 1:numel(L_set)
    L = L_set(l);
    plot((Tc-T_set)*L^exponent, sqrt(msquare_set(l,:))*L^exponent,'-o');hold on;
end

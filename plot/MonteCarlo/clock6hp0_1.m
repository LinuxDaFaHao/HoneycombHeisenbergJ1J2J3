L_set = [32, 64, 128,  256,384,512];
% 
beta_set = [100 10 8 7 6 5 4 3.5 3 2.7 2.3 2 1.8  1.5   1.2 1.1 1 0.9 0.8 0.7 0.6 0.5];
% 
...
%         data_type_size = numel(test_load);%4
        ...
        msquare_set(system_ind, beta_ind) = mean(msquare(~isnan(msquare)));
...
% l=legend('$L=32$','$64$','$128$', '$256$','$384$','$512$');%

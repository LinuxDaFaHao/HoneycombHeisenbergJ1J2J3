...
beta_set = [4 3.5 3 2.7 2.3 2 1.8 1.7 1.6 1.5 1.4 1.3 1.2 1.1 1 0.9 0.8 0.7 0.6 0.5];
%  
...
%         msquare = sum(averaged_data([6,7],:)) ;
        ...
        if( beta==1.7 || beta==1.6 || beta==1.4 || beta==1.3 ||...
                (L==128 && beta<=4&& beta>=2.7))
            binder_ratio = averaged_data(4,:);
        else
            binder_ratio = averaged_data(4,:) / (msquare * N* N);
        end
